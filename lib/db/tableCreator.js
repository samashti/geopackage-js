...
class TableCreator {
  ...
  async createRequired() {
    ...
    await this.createSpatialReferenceSystem()
    await this.createContents()
   ...
   * @return {Promise<Boolean>}
   */
  async createSpatialReferenceSystem() {
    return await this.createTable('spatial_reference_system');
  }
  /**
  ...
  async createContents() {
    return await this.createTable('contents');
  }
  /**
   * Creates the geometry columns tables
   * @return {Promise<Boolean>}
   */
  async createGeometryColumns() {
    return await this.createTable('geometry_columns');
  }
  /**
   * Creates the tile matrix set tables
   * @return {Promise<Boolean>}
   */
  async createTileMatrixSet() {
    return await this.createTable('tile_matrix_set');
  }
  /**
   * Creates the tile matrix tables
   * @return {Promise<Boolean>}
   */
  async createTileMatrix() {
    return await this.createTable('tile_matrix');
  }
  /**
  ...
  async createDataColumns() {
    return await this.createTable('data_columns');
  }
  /**
   * Creates the data column constraints tables
   * @return {Promise<Boolean>}
   */
  async createDataColumnConstraints() {
    return await this.createTable('data_column_constraints');
  }
  /**
  ...
  async createMetadata() {
    return await this.createTable('metadata');
  }
  /**
   * Creates the metadata reference tables
   * @return {Promise<Boolean>}
   */
  async createMetadataReference() {
    return await this.createTable('metadata_reference');
  }
  /**
  ...
  async createExtensions() {
    return await this.createTable('extensions');
  }
  /**
  ...
  async createTableIndex() {
    return await this.createTable('table_index');
  }
  /**
   * Creates the geometry index tables
   * @return {Promise<Boolean>}
   */
  async createGeometryIndex() {
    return await this.createTable('geometry_index');
  }
  /**
   * Creates the feature tile link tables
   * @return {Promise<Boolean>}
   */
  async createFeatureTileLink() {
    return await this.createTable('feature_tile_link');
  }
  /**
   * Creates the extended relations tables
   * @return {Promise<Boolean>}
   */
  async createExtendedRelations() {
    return await this.createTable('extended_relations');
  }
  /**
   * Creates the contentsId
   * @return {Promise<Boolean>}
   */
  async createContentsId() {
    return await this.createTable('nga_contents_id');
  }
  /**
   ...
   * @return {Promise<Boolean>}
   */
  async createTable(creationScriptName) {
    var connection = this.connection;
    let success = true;
    for (const sql of tableCreationScripts[creationScriptName]) {
      try {
      success = success && await !!connection.run(sql)
      } catch (error) {
