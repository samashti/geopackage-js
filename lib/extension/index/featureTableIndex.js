...
class FeatureTableIndex extends BaseExtension {
   ...
   * @return {Boolean} results of indexing
   */
  ...
  async getOrCreateExtension() {
    return await this.getOrCreate(this.extensionName, this.tableName, this.columnName, this.extensionDefinition, Extension.READ_WRITE);
  }
  /**
