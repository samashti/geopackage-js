...
describe('GeoPackage Feature table create tests', function() {
  ...
  it('should create a feature table', function() {
    ...
    columns.push(FeatureColumn.createGeometryColumn(1, 'geom.test', wkx.wkt.Point, false, null));
  ...
  it('should not create a feature table with two geometry columns', function() {
    ...
    columns.push(FeatureColumn.createPrimaryKeyColumnWithIndexAndName(0, 'id'));
    columns.push(FeatureColumn.createGeometryColumn(1, 'geom.test', wkx.wkt.Point, false, null));
    columns.push(FeatureColumn.createGeometryColumn(2, 'geom2.test', wkx.wkt.Point, false, null));
    (function() {
  ...
  describe('GeoPackage feature CRUD tests', function(done) {
    ...
    beforeEach(function() {
      var geometryColumns = SetupFeatureTable.buildGeometryColumns(tableName, 'geom', wkx.wkt.Point);
      var boundingBox = new BoundingBox(-180, 180, -80, 80);
